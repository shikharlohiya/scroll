...
function display_fun(element , class1 , class2 , class3 , class4 ,class5,y3,y4,stroke,class6, class7, class8) {
  console.log(element);
  console.log(stroke)
  tl.from(class1, {
    y: 50,
...
var tl3 = gsap.timeline({
  scrollTrigger: {
    ...
    onLeave: () => display_fun('3','.col1-left-part-4', 'left-sub-head-5', '#Opaque_Ring','.c3-rp-img-3','.c3-rp-img-1','-300','200','560','.c3-rp-img-2' , '.c3-rp-img-4' , '.c3-rp-img-5')
  }
});
...
var tl4 = gsap.timeline({
  scrollTrigger: {
    ...
    onEnterBack: () => display_fun('3','.col1-left-part-4', 'left-sub-head-5', '#Opaque_Ring','.c3-rp-img-3','.c3-rp-img-1','-300','200','560','.c3-rp-img-2' , '.c3-rp-img-4' , '.c3-rp-img-5'),
...
var tl5 = gsap.timeline({
  scrollTrigger: {
    ...
    onLeave: () => display_fun('5', '.col1-left-part-2','.left-sub-head-3','#Opaque_Ring','.c5-rp-img2','.c5-rp-img1','100','-200','840')
  }
});
...
var tl6 = gsap.timeline({
  scrollTrigger: {
    ...
    onEnterBack: () => display_fun('5', '.col1-left-part-6','.left-sub-head-3','#Opaque_Ring','.c5-rp-img2','.c5-rp-img1','100','-200','840'),
